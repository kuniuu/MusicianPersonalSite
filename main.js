...
verifiQuestions = [
  {question: "Podaj gatunek muzyczny", rightAnswer: "Rap", wrongAnswer1: "Gitara", wrongAnswer2: "Saksofon"},
  {question: "Jak nazywa się międzynarodowy konkurs muzyczny, który odbywa się w Europie?", rightAnswer: "Eurowizja", wrongAnswer1: "XFactor", wrongAnswer2: "Mam Talent"},
  {question: "Instrumentem klawiszowym nie jest ", rightAnswer: "Gitara", wrongAnswer1: "Fortepian", wrongAnswer2: "Pianino"},
  {question: "Instrumentem strunowym jest ", rightAnswer: "Harfa", wrongAnswer1: "Akordeon", wrongAnswer2: "Trąbka"},
];
...
function newQuestion() {
  ...
  let randomNumber = Math.floor(Math.random() * verifiQuestions.length);
  randomQuestion = verifiQuestions[randomNumber];
  answers = [
